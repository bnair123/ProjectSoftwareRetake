namespace TallyCounterUno.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.TallyCounterUno";
    public readonly static string AndroidAppName = "com.companyname.TallyCounterUno";
